...
from backend.games.friends_game.repository import get_player_by_sid, get_quiz_by_code, verify_host
from backend.games.friends_game.results import (
    assign_final_ranks,
...
from backend.games.friends_game.service import log_session_event, validate_quiz_code
